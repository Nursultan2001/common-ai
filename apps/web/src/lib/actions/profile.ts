...
export async function saveProfileAction(formData: FormData) {
  ...
  const data = {
    ...
    alternateMailingAddress: str(formData, "alternateMailingAddress"),
    ...
    armedForces: str(formData, "armedForces"),
    hispanicLatino: str(formData, "hispanicLatino"),
    raceEthnicity: multi(formData, "raceEthnicity"),
    ...
    collegeStartTerm: str(formData, "collegeStartTerm"),
    collegeAdmissionPlan: str(formData, "collegeAdmissionPlan"),
    collegeResidence: str(formData, "collegeResidence"),
    collegeSatActPlan: str(formData, "collegeSatActPlan"),
